...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction initFetchBitcoin() {\n  fetch('https://www.blockchain.com/ticker').then(function (response) {\n    return response.json();\n  }).then(function (bitcoin) {\n    var bitcoinPreco = document.querySelector('.bitcoin-preco');\n    bitcoinPreco.textContent = (1000 / bitcoin.BRL.sell).toFixed(4);\n  }).catch(function (err) {\n    console.log(\"Erro encontrado \".concat(err));\n  });\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (initFetchBitcoin);\n\n//# sourceURL=webpack:///./js/modules/initFetchBitcoin.js?");

/***/ }),

/***/ "./js/modules/initMobileMenu.js":
/*!**************************************!*\
  !*** ./js/modules/initMobileMenu.js ***!
  \**************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction initMobileMenu() {\n  var menuButton = document.querySelector(\".btn-toggle\");\n  var menuList = document.querySelector(\"#menu\");\n  var events = ['click', 'touchstart'];\n  events.forEach(function (userEvent) {\n    menuButton.addEventListener(userEvent, function (e) {\n      e.preventDefault();\n      menuButton.classList.toggle(\"ativo\");\n      menuList.classList.add(\"ativo\");\n\n      if (!menuButton.classList.contains(\"ativo\")) {\n        menuList.classList.remove(\"ativo\");\n      }\n    });\n  });\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (initMobileMenu);\n\n//# sourceURL=webpack:///./js/modules/initMobileMenu.js?");
...
/***/ "./js/modules/initNavigationTabs.js":
/*!******************************************!*\
  !*** ./js/modules/initNavigationTabs.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction initNavigationTabs() {\n  var tabsMenu = document.querySelectorAll('.animais-lista li');\n  var tabsContent = document.querySelectorAll('.animais-descricao section');\n  tabsContent[0].classList.add('ativo');\n  tabsMenu.forEach(function (tab, index) {\n    tab.addEventListener('click', function () {\n      tabsContent.forEach(function (content) {\n        return content.classList.remove('ativo');\n      });\n      tabsContent[index].classList.add('ativo');\n    });\n  });\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (initNavigationTabs);\n\n//# sourceURL=webpack:///./js/modules/initNavigationTabs.js?");

/***/ }),

/***/ "./js/modules/scrollLink.js":
/*!**********************************!*\
  !*** ./js/modules/scrollLink.js ***!
  \**********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction scrollLink() {\n  var links = document.querySelectorAll('.menu a[href^=\"#\"]');\n  links.forEach(function (link) {\n    link.addEventListener('click', function (e) {\n      e.preventDefault();\n      var href = e.currentTarget.getAttribute('href');\n      var section = document.querySelector(href);\n      window.scrollTo({\n        top: section.offsetTop,\n        behavior: 'smooth'\n      });\n    });\n  });\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (scrollLink);\n\n//# sourceURL=webpack:///./js/modules/scrollLink.js?");
